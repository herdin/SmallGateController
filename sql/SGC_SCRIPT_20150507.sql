...
-- Dumping data for table smallgatecontroller.area: ~9 rows (대략적)
DELETE FROM `area`;
...
-- Dumping data for table smallgatecontroller.card: ~4 rows (대략적)
DELETE FROM `card`;
...
-- Dumping data for table smallgatecontroller.cardgroup: ~6 rows (대략적)
...
-- Dumping data for table smallgatecontroller.gate: ~10 rows (대략적)
DELETE FROM `gate`;
...
-- Dumping data for table smallgatecontroller.grouparea: ~11 rows (대략적)
